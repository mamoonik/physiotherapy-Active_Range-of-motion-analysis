...
# 
# camera_video = cv2.VideoCapture('project_test_frontc_camera.avi')
...
with mp_face_mesh.FaceMesh(max_num_faces=1,refine_landmarks=True,min_detection_confidence=0.5,min_tracking_confidence=0.5) as face_mesh:
    ...
    while camera_video.isOpened(): # and camera_video_1.isOpened():
        # Read a frame.
        ...
        if a == 'l': #Lumbar AROM
            ...
            frame_final, label = classifyPose_lumbarAROM_3D(landmarks, frame, display=False)
...
#########################################################################################################
    ...
    # pass by reference.
        ...
        #lif landmarks:
        cv2.imshow('MediaPipe Pose Classification', frame_final)
